...
<body>
    ...
    if (req.url === '/' || req.url === '/home') {
        ...
        <div class="left_div">
            ...
            <h1 style="color: #15acff;">
                Laundary Serives!
            </h1>
            <p>
                From Premium dry cleaning to swift wash and fold, we deliver care and Convenience. Schedule a pickup and
        ...
        <div class="right_div">
            <img class="image"
                src="https://as2.ftcdn.net/jpg/04/35/40/29/1000_F_435402948_3ky1Bt4BK0QVZhk9rL19fJa0QQ9FIwbC.jpg" />
        </div>
    </div>`);
    }
...
`);
        ...
        <div class="quality-desc">
            ...
            <div class="key-attr">
                ...
                <p>Experience exceptional care without breaking the bank-our affordable prices make laundary day
                    stress-free</p>
            </div>
        </div>
    </section>`);
